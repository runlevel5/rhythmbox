...
#define RB_AUDIOSCROBBLER_USER_GET_PRIVATE(o) (rb_audioscrobbler_user_get_instance_private (o))
...
G_DEFINE_DYNAMIC_TYPE_EXTENDED (RBAudioscrobblerUser,
	rb_audioscrobbler_user,
	G_TYPE_OBJECT,
	0,
