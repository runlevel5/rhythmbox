...
class WebRemotePlugin(GObject.Object, RB.PeasActivatable):
    ...
    def do_activate(self):
        ...
        self.shell_player.connect(
            "playing-song-property-changed", self.playing_song_property_changed_cb
        )
        ...
        self.playing_song_changed_cb(
            self.shell_player, self.shell_player.get_playing_entry()
        )
        ...
        self.http_server.add_handler(
            path="/entry/current/stream", callback=self.http_track_cb
        )
        ...
        self.http_server.add_websocket_handler(
            "/ws/player", None, None, self.player_websocket_cb
        )
...
class WebRemoteConfig(GObject.Object, RB.PeasGtkConfigurable):
    ...
    def accesskey_focus_out_cb(self, controller):
        k = self.key_entry.get_text()
    ...
    def do_create_configure_widget(self):
        ...
        focus_controller.connect("leave", self.accesskey_focus_out_cb)
        self.key_entry.add_controller(focus_controller)
