...
G_DEFINE_TYPE_WITH_PRIVATE (RBShufflePlayOrder, rb_shuffle_play_order, RB_TYPE_PLAY_ORDER)
#define RB_SHUFFLE_PLAY_ORDER_GET_PRIVATE(o) (rb_shuffle_play_order_get_instance_private (o))
